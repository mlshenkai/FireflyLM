...
class DataCollatorForSupervisedDataset(object):
    ...
    def __call__(
        self, instances: Sequence[Dict[str, List[int]]]
        ...
        """
        assert (
            isinstance(self.tokenizer.pad_token_id, int)
        ...
        if self.tokenizer.padding_side == "right":
            ...
            if self.padding == "max_length":
                ...
                input_ids = F.pad(
                    input_ids, (0, to_pad), value=self.tokenizer.pad_token_id
                )
